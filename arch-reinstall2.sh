...
sudo pacman -S volumeicon network-manager-applet gxkb dunst polkit-gnome orage viewnior thunar lxappearance nitrogen xfce4-screenshooter xfce4-terminal rofi xorg-xev conky xfce4-taskmanager leafpad --noconfirm
