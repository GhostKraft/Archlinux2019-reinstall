...
pacman -S pcmanfm rofi lxappearance nitrogen polkit-gnome lxtask gparted xfce4-appfinder hardinfo neofetch xorg-xrandr dunst ristretto flameshot leafpad xorg-xev ntfs-3g bash-completion qt5-styleplugins qt5ct mpd mpc ncmpcpp mpv xreader slop xorg-xsetroot firefox firefox-i18n-ru gsimplecal p7zip unrar tar file-roller --noconfirm
