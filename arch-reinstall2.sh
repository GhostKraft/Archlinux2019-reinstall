...
pacman -S pcmanfm rofi lxappearance nitrogen polkit-gnome lxtask gparted hardinfo neofetch dunst viewnior flameshot leafpad xorg-xrandr xorg-xev ntfs-3g bash-completion qt5-styleplugins qt5ct audacious mpv xreader slop xorg-xsetroot firefox firefox-i18n-ru gsimplecal p7zip unrar tar file-roller --noconfirm
